...
export async function GET() {
  ...
  const body = [
    ...
    section("How buying works", [
      ...
      "2. Pay through Stripe Checkout. Consultations are priced and charged in AED, and the AED figure",
      "   shown on the site is the amount billed. Paid resources are charged in USD; the AED figure shown",
      "   against a resource is an approximate display conversion, not the amount billed.",

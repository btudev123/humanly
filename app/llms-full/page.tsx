...
export default async function LlmsFullPage() {
  ...
  return (
    <main className="mx-auto max-w-4xl px-5 py-28 md:px-[64px]">
      <h1 className="text-h1 font-extrabold text-primary-dark">Humanly LLM Summary</h1>
      ...
      <section className="mt-10">
        <h2 className="text-h3 font-extrabold text-primary-dark">Founder and E-E-A-T</h2>
      ...
      <section className="mt-10">
        <h2 className="text-h3 font-extrabold text-primary-dark">Services</h2>
        <ul className="mt-3 space-y-3 text-neutral-500">
          {serviceProducts.map((product) => (
            <li key={product.slug}>
              <strong>{product.name}</strong>: {product.description} Price: {formatAed(product.amountAed)}{product.priceNote ?? ""} (≈ {formatUsd(product.amount)}{product.priceNote ?? ""}, charged in USD).
            </li>
          ))}
        </ul>
      </section>
      <section className="mt-10">
        <h2 className="text-h3 font-extrabold text-primary-dark">Resources</h2>
      ...
      <section className="mt-10">
        <h2 className="text-h3 font-extrabold text-primary-dark">Canonical Pages</h2>
        <p className="mt-3 text-neutral-500">
